            ...
            <div class="col-lg-12 entries" style="margin-top:20px">
                <article class="entry entry-single">
                    <div class="entry-img d-flex justify-content-center">
                        <img src="{{ asset('storage/' . substr($bendungan->url_foto1, 6)) }}" alt="" class=""
                            style=" width: 150vw; ">
                    </div>
                    ...
                    <div class="entry-meta">
                        <ul>
                            <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="">{{
                                    $bendungan->created_at }}</time></a></li>
                        </ul>
                    </div>
                    {{-- <div class="container"> --}}
                        <div class="entry-content ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div>
                                        <img src="{{ asset('storage/' . substr($bendungan->url_foto2, 6)) }}" alt=""
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <img src="{{ asset('storage/' . substr($bendungan->url_foto3, 6)) }}" alt=""
                                            class="img-fluid">
                                    </div>
                                    <div>
                                        <img src="{{ asset('storage/' . substr($bendungan->url_foto4, 6)) }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
