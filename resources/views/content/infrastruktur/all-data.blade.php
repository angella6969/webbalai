        ...
        <div class="row">
            ...
            <div class="col-lg-4 entries" style="margin-top:20px">
                <article class="entry entry-single">
                    <a href="/informasi-publik/infrastruktur/{{ $infrastrukturs->jenis }}/{{ $infrastrukturs->slug }}">
                        <div class="entry-img d-flex justify-content-center">
                            <img src="{{ asset('storage/' . substr($infrastrukturs->url_foto1, 6)) }}" alt=""
                    ...
                    <div class="entry-meta">
                        <ul>
                            <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="">{{
                                    $infrastrukturs->created_at }}</time></a></li>
                        </ul>
                    </div>
