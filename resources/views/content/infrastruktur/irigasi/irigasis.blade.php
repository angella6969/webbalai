                    ...
                    <div class="col-lg-4 entries" style="margin-top:20px">
                        <article class="entry entry-single">
                            <div class="entry-img d-flex justify-content-center">
                                <img src="{{ asset('storage/' . substr($irigasi->url_foto1, 6)) }}" alt=""
                                    class="img-fluid" style="border-radius: 5px">
                                {{-- <img src="{{ asset('images\image\struktur_organisasi\irigasi_Sermo-1.jpg') }}"
                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                            href="">{{ $irigasi->created_at }}</time></a></li>
                                </ul>
                            </div>
