                        ...
                        <div class="entry-content ">
                            ...
                            <div class="row">
                                    ...
                                    <table class="table table-responsive">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->wilaya_sungai }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>DAERAH ALIRAN SUNGAI</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->daerah_sliran_sungai }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>TAHUN PEMBANGUNAN</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->tahun_mulai_pembangunan }} -
                                                    {{ $bendung->tahun_selesai_pembangunan }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>TINGGI DASAR SUNGAI</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->tinggi_dasar_sungai }} M</td>
                                            </tr>
                                            <tr>
                                                <td><strong>PANJANG PUNCAK</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->panjang_puncak }} M</td>
                                            </tr>
                                            <tr>
                                                <td><strong>LEBAR PUNCAK</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->lebar_puncak }} M</td>
                                            </tr>
                                            <tr>
                                                <td><strong>ELEVASI PUNCAK</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->elevasi_puncak }} M</td>
                                            </tr>
                                            <tr>
                                                <td><strong>VOLUME TAMPUNG NORMAL (M3)</strong></td>
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->volume_tampung_normal }} M</td>
                                            </tr>
                                            <tr>
                                                <td><strong>VOLUME TAMPUNG NORMAL (M3)</strong></td>
                                                <td><strong>:</strong></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><strong>:</strong></td>
                                                <td>{{ $bendung->volume_tampung_total }} M</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="col-6">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/' . substr($bendung->url_foto3, 6)) }}" alt=""
                                            class="img-fluid">
                                    </div>
                                    <div>
