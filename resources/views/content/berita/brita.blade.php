                ...
                <div class="col-lg-8 entries" style="margin-top:20px">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img d-flex justify-content-center">
                            <img src="{{ asset($berita->url_foto) }}" alt="" class="img-fluid" style="border-radius: 5px">
                        </div>
                        ...
                        <div class="entry-meta">
                            <ul>
                                {{-- <li class="d-flex align-items-center"><i class="bi bi-person"></i> <p>{{$berita->tanggal}}</p></li> --}}
