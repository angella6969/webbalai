                                    ...
                                    <div>
                                        <a style="color: black"
                                            href="/informasi-publik/infrastruktur/{{ $infrastruktur->jenis }}/{{ $infrastruktur->slug }}"><img
                                                style="width: 40px" src="{{ asset('images\icon\snowplow.png') }}"
                                                alt="">
                                            {{ $infrastruktur->nama }}
                                        </a>
                                        <p>
                    ...
                    @foreach ($berita as $berit)
                        <article class="entry entry-single">
                            <div class="sidebar-item recent-posts" style="overflow: auto;">
                                <div class="post-item clearfix">
                                    <div>
                                        <a style="color: black" href="/beritas/{{ $berit->slug }}"><img style="width: 40px"
                    ...
                    @foreach ($galeris as $galeri)
                        <article class="entry entry-single">
                            <div class="sidebar-item recent-posts" style="overflow: auto;">
                                <div class="post-item clearfix">
                                    <div>
                                        <a style="color: black" href="/media/galeri/video/{{ $galeri->slug }}"><img
                                                style="width: 40px" src="{{ asset('images\icon\youtube.png') }}"
                                                alt="">
                                            {{ $galeri->nama }}
                                        </a>
