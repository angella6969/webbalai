        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 order-1 mb-5 mb-md-0">
                <article class="blog-post mb-4">
                    ...
                    <header class="blog-post-header mt-3 mb-3" style="position: relative; overflow: hidden;" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h2 class="text-center mb-4 mt-4" style=" line-height: 1.2; margin-right: 0px; margin-left: 0px;" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="mb-4" style="line-height: 1.9; margin-right: 0px; margin-left: 0px;" data-aos="fade-up" data-aos-delay="100"><span
                            style="font-size: 18px;">Pencapaian visi tersebut dilaksanakan melalui pelaksanaan misi
                            Presiden dan Wakil Presiden,
                            sebagai berikut:</span></p>
                    <h2 data-aos="fade-up" data-aos-delay="100">Visi</h2>
                    <ol class="mb-3 mt-3" style=" text-align: justify; font-family: &quot;Open Sans&quot;, sans-serif;" data-aos="fade-up" data-aos-delay="100">
                        <p>
                    ...
                    <h2 data-aos="fade-up" data-aos-delay="100">Misi</h2>
                    <ol class="mb-3 mt-3" style=" text-align: justify; font-family: &quot;Open Sans&quot;, sans-serif;" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h2 data-aos="fade-up" data-aos-delay="100">Tujuan</h2>
                        ...
                        <p style="text-align: left; text-align: justify;" data-aos="fade-up" data-aos-delay="100"><span
                                ...
                                <li data-aos="fade-up" data-aos-delay="100"> 
                                    <p>Tujuan
                                        ...
                                        pencapaian
                                        target infrastruktur pelayanan dasar dalam rangka memperkuat ketahanan ekonomi
                                        untuk
                                ...
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <p>Tujuan 2:
                                        ...
                                        untuk
                                        pengelolaan air tanah dan air baku berkelanjutan, infrastruktur ketahanan
                                        bencana, serta
                                        waduk multiguna dan modernisasi irigasi, dalam rangka penyediaan infrastruktur
                                        pelayanan
                                        dasar.</p>
                                </li>
                            </span><br /><span style="color: #000000;">
                                <li data-aos="fade-up" data-aos-delay="100">
                                    <p>Tujuan 3: Menyelenggarakan tata
                                        ...
                                        manusia, sarana prasarana pendukung, pengendalian dan pengawasan, serta sumber
                                        daya yang
                                        lainnya untuk meningkatkan kehandalan infrastruktur pekerjaan umum dan perumahan
                                        rakyat
                                        bidang sumber daya air yang efektif, efiesien, transparan dan akuntabel.</p>
                                </li>
                            </span></p>
                        </p>
                    </ol>
