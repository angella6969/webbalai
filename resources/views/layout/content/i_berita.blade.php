        ...
        @foreach ($beritas as $berita)
            <div class="swiper-slide">
                <div class="card " style="border: 10px">
                    <a href="/balai/bbwsserayuopak/beritas/{{ $berita->slug }}"><img <a
                            href="beritas/{{ $berita->slug }}"><img
                    ...
                    <div class="card-body">
                        <h6 class="font-weight-bold text-4 mb-1"><a
                                href="/balai/bbwsserayuopak/beritas/{{ $berita->slug }}"
