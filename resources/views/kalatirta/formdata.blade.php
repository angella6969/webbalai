...
<body>
	...
	<svg style="display:none;">
		...
		<symbol id="twitterx" width="16" height="16" viewBox="0 0 16 16">
			...
			<path fill="#ffffff" d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"></path>
		</symbol>
		...
		<symbol id="tiktok" width="16" height="16"  viewBox="0 0 16 16">
			...
			<path fill="#ffffff" d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"></path>
		</symbol>
		<!-- ==contact== -->
		<symbol id="address" xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" viewBox="-10 -5 37 28">
			<path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"></path>
		</symbol>
		<symbol id="email" xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" viewBox="-10 -5 37 28">
  			<path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"></path>
		</symbol>
		<symbol id="phone" xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" viewBox="-10 -5 37 28">
	...
	<section id="topbar">
		...
		<div class="container section-info social-links">
			...
			<svg class="icon"><use xlink:href="#twitterx"></use></svg>
			<svg class="icon"><use xlink:href="#youtube"></use></svg>
			<svg class="icon"><use xlink:href="#tiktok"></use></svg>
      </div>
	</section>
	<header id="header">
		<div class="container section-row">
			<a href="#"><img src="/images/kal-logo1.png" alt=""></a>
			<div class="navbar">
				<ul>
					<li>
			...
			<svg class="navToggle"><use xlink:href="#navToggle"></use></svg>
		</div>
	</header>
