    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/balai/bbwsserayuopak/dashboard/galeri/video">
                    <div class="row">
                ...
                <div class="mt-2 mb-2">
                    <a href="/balai/bbwsserayuopak/dashboard/galeri/video/create" class="btn btn-info">Tambah video</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($videos as $video)
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        <a href="/balai/bbwsserayuopak/dashboard/galeri/video/{{ $video->id }}/edit"
                                            class="bg badge bg-warning"><span data-feather="edit">
                                            </span></a>

                                        <form action="/balai/bbwsserayuopak/dashboard/galeri/video/{{ $video->id }}"
