...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <form action="/dashboard/galeri/video">
                <div class="row">
            ...
            <div class="mt-2 mb-2">
                <a href="/dashboard/galeri/video/create" class="btn btn-info">Tambah video</a>
            </div>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td>
                                <a href="/dashboard/galeri/video/{{ $video->id }}/edit"
                                    class="bg badge bg-warning"><span data-feather="edit">
                                    </span></a>

                                <form action="/dashboard/galeri/video/{{ $video->id }}" class="d-inline " method="POST">
                                    @csrf
                                    @method('DELETE')
