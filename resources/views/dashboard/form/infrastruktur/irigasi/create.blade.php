            ...
            <div class="card-body">
                ...
                <form method="post" action="/dashboard/infrastruktur/irigasis" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="daerah_sliran_sungai" name="daerah_sliran_sungai"
                                placeholder="daerah_sliran_sungai" value="{{ old('daerah_sliran_sungai') }}" required>
                        </div>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="tinggi_dasar_sungai" name="tinggi_dasar_sungai"
                                placeholder="tinggi_dasar_sungai" value="{{ old('tinggi_dasar_sungai') }}" required>
                        </div>
                    </div>
                    <div class="mt-3">
