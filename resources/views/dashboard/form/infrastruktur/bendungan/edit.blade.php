    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="/balai/bbwsserayuopak/dashboard/infrastruktur/bendungans{{ $bendungan->id }}"
                    ...
                    <div class="mb-3">
                        <div style="z-index: 999">
                            <textarea id="body" name="body" style="width: 100px;" hidden>{{ old('body', $bendungan->body) }}</textarea>
                        </div>
                    </div>
