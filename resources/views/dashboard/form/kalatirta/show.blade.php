            ...
            <form method="post" action="/dashboard/kalatirta-so/{{ $data->id }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <div style="z-index: 999">
                        ...
                        <textarea id="informasi" name="informasi" style="width: 100px;"
                            hidden>{{ old('informasi', $data->informasi) }}</textarea>
                    </div>
                </div>
                <div class="mb-3">
                    <div style="z-index: 999">
                        <label for="">Tujuan Data Digunakan</label>
                        <textarea id="tujuan" name="tujuan" style="width: 100px;"
                            hidden>{{ old('tujuan', $data->tujuan) }}</textarea>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="status" id="status" required>
                        <option value="" {{ old('status', $data->status) === null ? ($data->status == '' ? 'selected' :
                            '') : 'selected' }}>
                            Kategori
                        </option>
                ...
                <div class="mt-3" id="additionalInput" style="display: none;">
                    ...
                    <textarea id="keterangan" name="keterangan" style="width: 100px;"
                        hidden>{{ old('keterangan', $data->keterangan) }}</textarea>
                </div>
