    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/balai/bbwsserayuopak/dashboard/kinerja/lakip">
                    <div class="row">
                ...
                <div class="mt-2 mb-2">
                    <a href="/balai/bbwsserayuopak/dashboard/kinerja/lakip/create" class="btn btn-info">Tambah LAKIP</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($lakips as $lakip)
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        <a href="/balai/bbwsserayuopak/dashboard/kinerja/lakip/{{ $lakip->id }}/edit"
                                            class="bg badge bg-warning"><span data-feather="edit">
                                            </span></a>

                                        <form action="/balai/bbwsserayuopak/dashboard/kinerja/lakip/{{ $lakip->id }}"
