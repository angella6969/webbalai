            ...
            <div class="appear-animation animated fadeInLeftShorter appear-animation-visible"
                ...
                <article class="card rounded border-0 p-0">
                    ...
                    <a cek-gambar="1"
                        ...
                        aria-label="Move to top" data-uw-rm-empty-ctrl=""><img
                            ...
                            class="card-img-top hover-effect-2" alt="" style="height: 200px;object-fit: none;"
                            data-uw-rm-alt-original="" role="presentation" data-uw-rm-alt="HD"></a>
