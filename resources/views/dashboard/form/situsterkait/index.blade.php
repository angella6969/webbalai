...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <form action="/dashboard/situs-terkait">
                <div class="row">
            ...
            <div class="mt-2 mb-2">
                <a href="/dashboard/situs-terkait/create" class="btn btn-info">Tambah situs</a>
            </div>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td>
                                <a href="/dashboard/situs-terkait/{{ $situs->id }}/edit"
                                    class="bg badge bg-warning"><span data-feather="edit">
                                    </span></a>

                                <form action="/dashboard/situs-terkait/{{ $situs->id }}" class="d-inline "
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
