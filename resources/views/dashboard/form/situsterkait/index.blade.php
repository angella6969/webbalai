...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('situs-terkait.index') }}">
                <div class="row">
            ...
            <div class="mt-2 mb-2">
                <a href="{{ route('situs-terkait.create') }}" class="btn btn-info">Tambah situs</a>
            </div>
                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td> <img style="height: 150px" src={{ asset('storage/' .substr($situs->image,6)) }} alt="">
                            </td>
                            <td> {{ $situs->url_situs }}</td>

                            <td>
                                <a href="{{ route('situs-terkait.edit', ['situs_terkait' => $situs->id]) }}"
                                    class="bg badge bg-warning"><span data-feather="edit">
                                    </span></a>

                                <form action="{{ route('situs-terkait.destroy', ['situs_terkait' => $situs->id]) }}" class="d-inline "
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
