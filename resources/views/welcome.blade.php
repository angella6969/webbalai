            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Layanan</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li class="dropdown"><a href="#"><span>Kalatirta</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="keyword" id="s"
                            style="width: 200px; height:30px ;" placeholder="Cari..." required="" aria-label="cari..."
                            data-uw-rm-form="fx">
                        </span>
                    </div>
                </ul>
    ...
    <div class="col-lg-12" style="height: 60px; color:#fff; background: rgb(232,170,28); ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-8 " style="margin: 10px 0px 10px 0px;" id="info-container"></div>
            </div>
        </div>
    </div>
                ...
                <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card ">
                                <a href=""><img src="{{ asset($berita->url_foto) }}" class="card-img-top hover-effect-2"
                                        alt="" style="height: 200px;object-fit: none;"></a>

                                <div class="card-body">
                                    <h3 class="font-weight-bold text-4 mb-1"><a href="" class="link-color-dark">{{
                                            $berita->judul }}</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="border:none">
                                <a href=""><img src="{{ asset($logoTerkait->url_logo) }}"
                                        class="card-img-top hover-effect-2" alt="" style="border-radius: 50%;  "></a>
                            </div>
                            <div class="card-body">
                                <h3 class="font-weight-bold text-4 mb-1"><a href=""
                                        class="link-color-dark d-flex justify-content-center">{{ $logoTerkait->name
                                        }}</a>
                                </h3>
                            </div>
        ...
        <div class="container">
            ...
            <div class="social-links">
                ...
                <div class="d-flex justify-content-center">
                    <a href="https://twitter.com/pupr_sda_so?lang=id" class="twitter"><i class="bx bxl-twitter"></i></a>
                    <a href="https://www.facebook.com/serayuopak/" class="facebook"><i class="bx bxl-facebook"></i></a>
                    <a href="https://www.instagram.com/pupr_sda_serayuopak/?hl=id" class="instagram"><i
                            class="bx bxl-instagram"></i></a>
                    <a href="https://www.youtube.com/channel/UClOhOH8Ixk2dcIAS9jr2aqg" class="google-plus"><i
